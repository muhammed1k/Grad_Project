...
export default function Signup() {
  ...
  let history = useHistory();
    ...
    const sendEmail = (e) => {
      ...
      emailjs.send('Gmail_cv60k5o', 'template_67w3yzb',{
    ...
    const onSubmit = () =>{
      ...
      toastError("user Exist")
      
      
    }).catch(err => {
      toastError("user Exist",err)
...
function MyVerticallyCenteredModal({onSubmit,email,...props}) {
