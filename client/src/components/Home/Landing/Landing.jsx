            ...
            <div className="col-md-6 col-sm-12 d-flex justify-content-center  align-items-center">
              <div className="text-content">
                ...
                <div className="buttons">
                  <Link to="/CreateRides" className="btn btn-lg btn-success mx-2"> <i className="fa-solid fa-map-location"></i> offer a ride</Link>
                  <Link to="/FindRides" className="btn btn-lg btn-outline-success mx-2 color-light "><span className=""><i className="fa-solid fa-magnifying-glass-location"></i> find a ride</span></Link>
                </div>
              </div>
            </div>
